...
local Window = Luna:CreateWindow({
    Name = "Zuyi Tenaki Hub Blue Lock Rivals",
...
MainTab:CreateButton({
    Name = "🔥 - (NEW) Get Itadori Yuji Style!",
    Description = "🔥 - Loads the Itadori Yuji Style Script",
    Callback = function()
...
MainTab:CreateButton({
    ...
    Description = "🇧🇷 - Loads the Lavinho Style Script",
    Callback = function()
